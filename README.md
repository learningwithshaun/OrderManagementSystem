...
Additionally, I was introduced to the controller layer, which acts as the entry point for handling client requests. Testing the API was one of the most engaging parts of the process, as it allowed me to see everything come together in a practical way.

Overall, this was a valuable learning experience that strengthened my understanding of backend development concepts and motivated me to keep building and improving my skills.
